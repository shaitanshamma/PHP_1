...
<div class="container">
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <div class="carousel__item d-flex justify-content-center">
                        <img src="<?= SRC . $product['img'] ?>" class="d-block w-100" alt="...">
    ...
    <section class="custom_prod">
        <?php if ($product != null): ?>
            <div class="wrapper">
                <div class="custom_prod_desc">
                    <h5>OUR COLLECTION!</h5>
                    <h4><?= $product['title'] ?></h4>
                    <p class="custom_prod_desc_p"><?= $product['description'] ?> </p>
                    ...
                    <div class="order__button">
                        <a href="cart.html">
                            <div class="add_to_card_block_prod_page">
                                ...
                                <p class="order__button_p">Add to Cart</p>
                            </div>
                        </a>
                    </div>
                </div>
                <?php foreach ($productEntity as $feedback) : ?>
                    <div class="feedback">
